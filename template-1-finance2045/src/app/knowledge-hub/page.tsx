...
export const metadata: Metadata = { title: "Knowledge Hub | Finance 2045 Jakarta 2026", description: "Research, insights, and white-papers from the Finance 2045 ecosystem." };
    ...
    <>
      ...
      <div className="sk-page">
        <div className="sk-hero">
          <div className="sk-ey"><span style={{width:6,height:6,borderRadius:"50%",background:"var(--teal)",display:"inline-block"}}/>Knowledge Hub</div>
          <h1 className="sk-h1">Knowledge Hub</h1>
          <p className="sk-p">Research, insights, and white-papers from the Finance 2045 ecosystem.</p>
        </div>
