...
export const metadata: Metadata = { title: "Photo Gallery | Finance 2045 Jakarta 2026", description: "Highlights from past Trescon global summits." };
    ...
    <>
      ...
      <div className="sk-page">
        <div className="sk-hero">
          <div className="sk-ey"><span style={{width:6,height:6,borderRadius:"50%",background:"var(--teal)",display:"inline-block"}}/>Networking · Photo Gallery</div>
          <h1 className="sk-h1">Photo Gallery</h1>
          <p className="sk-p">Highlights from past Trescon global summits.</p>
        </div>
