...
export const metadata: Metadata = { title: "AI Matchmaking | Finance 2045 Jakarta 2026", description: "Pre-schedule targeted 1-on-1 meetings up to 15 days before the summit." };
    ...
    <>
      ...
      <div className="sk-page">
        <div className="sk-hero">
          <div className="sk-ey"><span style={{width:6,height:6,borderRadius:"50%",background:"var(--teal)",display:"inline-block"}}/>Networking · AI Matchmaking</div>
          <h1 className="sk-h1">AI Matchmaking</h1>
          <p className="sk-p">Pre-schedule targeted 1-on-1 meetings up to 15 days before the summit.</p>
        </div>
