...
export const metadata: Metadata = { title: "WhatsApp Networking | Finance 2045 Jakarta 2026", description: "Join the official Finance 2045 WhatsApp community for real-time updates." };
    ...
    <>
      ...
      <div className="sk-page">
        <div className="sk-hero">
          <div className="sk-ey"><span style={{width:6,height:6,borderRadius:"50%",background:"var(--teal)",display:"inline-block"}}/>Networking · WhatsApp</div>
          <h1 className="sk-h1">WhatsApp Networking</h1>
          <p className="sk-p">Join the official Finance 2045 WhatsApp community for real-time updates.</p>
        </div>
